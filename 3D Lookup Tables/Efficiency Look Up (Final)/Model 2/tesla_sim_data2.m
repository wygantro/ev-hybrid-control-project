...
torque_allocation=linspace(0.01,1,d);                  %Torque allocation percentage (TR=front motor, 1-TR=rear motor)

load('opt_output_power_location2');
load('opt_output_torque_location2');
load('opt_output_efficiency_location2');