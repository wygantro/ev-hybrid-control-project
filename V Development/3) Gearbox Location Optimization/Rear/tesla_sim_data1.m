...
load('opt_output_efficiency_location112');
load('K_lookup_eff');
K_lookup_real_eff=K_lookup_eff.*ones(d,d);

load('opt_output_torque_location112');
load('K_lookup_tor');
K_lookup_real_tor=K_lookup_tor.*ones(d,d);

load('opt_output_power_location112');
load('K_lookup_pow');
K_lookup_real_pow=K_lookup_pow.*ones(d,d);