...
m_peak_trq_R = 660.28; %Nm  % Rear motor specs from google
m_peak_trq_F = 329.46; %Nm  % Front motor specs from google  
m_peak_pwr = 310; %kW  % 
m_map_spd = [0	100	250	500	1000	1500	2000	2500	3000	4000	4500	5500	6000	7000	8000	9000	10000]*(2*pi)/60;
m_max_trq_R = min(m_peak_trq_R, m_peak_pwr*1000./m_map_spd); % estimation by published peak torque and power
m_max_trq_F = min(m_peak_trq_F, m_peak_pwr*1000./m_map_spd); % estimation by published peak torque and power
m_max_gen_trq=-m_max_trq_R-m_max_trq_F; % estimate
